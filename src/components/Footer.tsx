...
const Footer = () => {
    return (
        <footer className="bg-purple-800/70 text-white py-16">
            ...
            <div
                className="container mx-auto px-4 flex flex-col space-y-8 md:flex-row md:space-y-0 md:justify-between md:items-center relative z-10">
                ...
                <div className="max-w-sm space-y-4">
                    ...
                    <p className="text-gray-300">
                        Take the next step in your career journey with Gighaven . Designed to streamline the Job hunt
                        process, our personalized Feed matches and helps you connect with top employers and recruiters.
                    </p>
                </div>
            </div>
