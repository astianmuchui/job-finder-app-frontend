    ...
    return (
        <div className={"bg-purple-100 w-[100vw] h-[100vh] flex justify-center items-center"}>
            <div
                ...
                <div className={"overflow-hidden w-[100%] lg:w-[40%] h-[100%] bg-white "}>
                    {form}
                </div>
                <div className={ "hidden lg:w-[60%] h-[100%] bg-transparent lg:flex justify-center items-center bg-purple-800"}>
